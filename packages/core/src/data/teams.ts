...
export const TEAMS: TeamSeed[] = [
  ...
  // Tier 2 - Strong clubs (reputation 75-84)
  {
    ...
    primaryColor: '#000000',
    secondaryColor: '#FFFFFF',
    stadium: 'Estádio Milton Caraglio',
    capacity: 46000,
    reputation: 84,
    budget: 45_000_000,
