...
function getPositionWeights(position: Position): Partial<Record<keyof PlayerAttributes, number>> {
  switch (position) {
    case 'GK':
      return { reflexes: 3, handling: 3, diving: 3, positioning: 2, composure: 1 }
    case 'CB':
      return { tackling: 3, heading: 2, strength: 2, positioning: 2, composure: 1 }
    case 'LB':
    case 'RB':
      return { tackling: 2, speed: 2, stamina: 2, passing: 1, positioning: 1 }
    case 'CDM':
      return { tackling: 3, positioning: 2, passing: 2, stamina: 1, strength: 1 }
    case 'CM':
    ...
    case 'ST':
      return { shooting: 3, positioning: 2, heading: 2, composure: 2, dribbling: 1 }
    default:
